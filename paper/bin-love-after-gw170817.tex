...
Although the improved binary Love relation $\Lambda_a^{\text{relation}}(\Lambda_s,q)$ shows a high degree of universality, any residual EoS dependance in the relation could introduce a systematic bias and lead to incorrect inferences about the correct EoS. Let us then discuss a method to marginalize over the residual EoS-dependence of the binary Love relations. The residual is here defined as 
\begin{equation}
\label{eq:residual}
