...
{\ny{Overall, let's not call these relations ``I-Love-Q EOS insensitive relations'' or ``binary love EOS insensitive relations.''  It's much better to be brief and simply call them I-Love-Q relations and Binary Love relations (like is done in the literature). It should be clear when we define them that they are EOS insensitive}}
...
{\ny{This is a bit strange, but probably still correct. But ``this'' I mean the fact that when you fit only to the hybrid stars you do not get better than $1\%$ universality. Why is this?}}
