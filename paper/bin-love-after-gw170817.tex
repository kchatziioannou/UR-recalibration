...
Similar to before, we used fiducial template parameter values of $D_L=21.7$ Mpc for the luminosity distance, $\mathcal{M}=1.22\text{ M}_\odot$ for the chirp mass, $\eta=0.249$ for the symmetric mass ratio, $\lambda_0=150$, $\lambda_1=-213$ (corresponding to the GW170817), and $0$ for the remaining parameters.
