...
\end{equation}
Figure~\ref{fig:residuals} shows a histogram of ${\cal{R}}$ for both the constrained and unconstrained set of EoSs, \sout{which approximately obeys a Gaussian distribution}\kc{it does not}. The standard deviations of the two histograms, $\sigma=9.764$ and $\sigma=78.28$, show a large decrease in EoS-variability from the unconstrained to the constrained sets of EoSs. From this distribution, we can additionally find the 90\%, 99\%, and 100\% credible interval on $\lambda_0$, namely $P_{90}=13.19$, $P_{99}=42.38$, and $P_{100}=111.32$ for the constrained EoSs.
...
\sout{These residuals obey} \kc{We fit these residuals with} Gaussian distributions centered at $\mu=-0.1530$ and $\mu=0.2710$ with standard deviations of $\sigma=9.764$ and $\sigma=78.28$ for the constrained and unconstrained sets of EoSs, respectively.
...
\kc{I am not sure how this appendix fits with the rest of the paper. I don't even see it referenced in the text. Remove?}
