...
Similar to the fits performed for the I-Love-Q and C-Love universal relations, we fit the R-Love relations to Eq.~\ref{eq:ILQfitNew} with a newtonian control factor the same as used in the C-Love case seen in Eq.~\ref{eq:cloveFit}, where the NS mass is substituted with the polytropic form $M\propto R^{(3-n)/(1-n)}$\zc{Anyone have a cite for this?}.
